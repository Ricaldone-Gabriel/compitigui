 ...
 * @author gigga
 */
public class es3 extends javax.swing.JFrame {

    /**
     * Creates new form es3
     */
    public es3() {
        initComponents();
    }
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton17ActionPerformed
        ...
        if(somma) {
            ...
            risultato =num1+num2;
            num1 = risultato;
            jLabel1.setText(String.valueOf(risultato));
        } 
        if (sottrazione) {
            num2 = Double.parseDouble(jLabel1.getText());
            risultato =num1-num2;
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        // TODO add your handling code here:
        if(negativo) {
            jLabel1.setText(String.valueOf(Math.abs(Double.parseDouble(jLabel1.getText()))));
        } else {
            jLabel1.setText(String.valueOf(Double.parseDouble(jLabel1.getText())*-1));
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(es3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
